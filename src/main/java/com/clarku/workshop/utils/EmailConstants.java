...
public class EmailConstants {
	...
	public static final String WORKSHOP_SUCCESS_UNENROLL_SUB = "Workshop UnEnrolled Successfully";
	public static final String WORSHOP_UNENROLL_SUCCESS_TEMPLATE = "workshopUnEnrollSuccess";
